...
RUN apt-get install -y libnetcdf-dev libnetcdff-dev libncarg-dev nco netcdf-bin
RUN wget https://w3.pppl.gov/rib/repositories/NTCC/files/pspline.tar.gz --no-check-certificate
