...
! return codes 
      ...
      parameter (MPI_HEADER_FILE = 'mpif90_Linux_mvapich.h')
...
!
      PARAMETER (MPI_COMPLEX=23+iRealPrec,MPI_DOUBLE_COMPLEX=24,MPI_LOGICAL=25)
      PARAMETER (MPI_REAL=26+iRealPrec,MPI_DOUBLE_PRECISION=27,MPI_INTEGER=28)
