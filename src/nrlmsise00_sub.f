c
c *** This has been modified to avoid conflicts with the irifun_2012 ***
c In particular, underscores for spline and splint
c
...
c
     ...
     $ PMA(100,10),SAM(100)
      CHARACTER(2) IST,NAM,ISTIME,NAME
      CHARACTER(3) ISD,ISDATE
...
c       Calculate spline coefficients
      CALL SPLINE__(XS,YS,MN,YD1,YD2,Y2OUT)
      X=ZG/ZGDIF
      CALL SPLINT__(XS,YS,Y2OUT,MN,X,Y)
c       temperature at altitude
      TZ=1./Y
      DENSU=TZ
...
c        Density at altitude
   ...
   50 CONTINUE
      ...
      END
c-----------------------------------------------------------------------
      SUBROUTINE SPLINE__(X,Y,N,YP1,YPN,Y2)
...
c        Y2: OUTPUT ARRAY OF SECOND DERIVATIVES
   ...
   12 CONTINUE
      ...
      END
c-----------------------------------------------------------------------
      SUBROUTINE SPLINT__(XA,YA,Y2A,N,X,Y)
