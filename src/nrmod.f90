...
!BL
        ...
        INTERFACE
                ...
                USE nrtype
                REAL(DP), DIMENSION(:,:), INTENT(INOUT) :: covar   ! changed to DP
...
!BL
        ...
        END INTERFACE
        INTERFACE
                SUBROUTINE gaussj(a,b)   ! changed type do DP
                USE nrtype
...
!BL
        ...
        END INTERFACE
        INTERFACE
                SUBROUTINE svdfit(x,y,sig,a,v,w,chisq,funcs) ! Type changed to DP
                USE nrtype
                REAL(DP), DIMENSION(:), INTENT(IN) :: x,y,sig
