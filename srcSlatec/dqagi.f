...
10    IF(IER.EQ.6) LVL = 1
      IF (IER .NE. 0 .AND. IER.NE.4) CALL XERMSG ('SLATEC', 'DQAGI',
     +   'ABNORMAL RETURN', IER, LVL) ! Added 4 as that error just shows desired tolerance cannot be achieved, results is best that can  be obtained 
      RETURN
      END
